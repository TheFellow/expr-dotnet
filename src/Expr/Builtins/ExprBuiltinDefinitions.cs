...
internal static class ExprBuiltinDefinitions
{
    ...
    [
        ...
        Function("string", ExprBuiltinValues.String, [O(ExprTypes.String, false, ExprTypes.Any)]),
        Function("trim", ExprBuiltinStrings.Trim,
            [O(ExprTypes.String, false, ExprTypes.String), O(ExprTypes.String, false, ExprTypes.String, ExprTypes.String)]),
        Function("trimPrefix", ExprBuiltinStrings.TrimPrefix,
            [O(ExprTypes.String, false, ExprTypes.String), O(ExprTypes.String, false, ExprTypes.String, ExprTypes.String)]),
        Function("trimSuffix", ExprBuiltinStrings.TrimSuffix,
            [O(ExprTypes.String, false, ExprTypes.String), O(ExprTypes.String, false, ExprTypes.String, ExprTypes.String)]),
        Function("upper", ExprBuiltinStrings.Upper, [O(ExprTypes.String, false, ExprTypes.String)]),
        Function("lower", ExprBuiltinStrings.Lower, [O(ExprTypes.String, false, ExprTypes.String)]),
        Function("split", ExprBuiltinStrings.Split,
            [O(AnyArray, false, ExprTypes.String, ExprTypes.String), O(AnyArray, false, ExprTypes.String, ExprTypes.String, ExprTypes.Integer)]),
        Function("splitAfter", ExprBuiltinStrings.SplitAfter,
            [O(AnyArray, false, ExprTypes.String, ExprTypes.String), O(AnyArray, false, ExprTypes.String, ExprTypes.String, ExprTypes.Integer)]),
        Function("replace", ExprBuiltinStrings.Replace,
        ...
        Function("join", ExprBuiltinStrings.Join,
    ...
    private static ExprFunction Safe(
        ...
        IReadOnlyList<ExprFunctionOverload> overloads) => new(name, overloads, safeInvoker: invoker);
